...
mysql --user="root" --password="$MYSQL_ROOT_PASSWORD" -e "CREATE DATABASE ${DB_DATABASE} /*\!40100 DEFAULT CHARACTER SET utf8 */;"
mysql --user="root" --password="$MYSQL_ROOT_PASSWORD" -e "CREATE USER '${USER}'@'$SERVER_IP' IDENTIFIED BY '${DB_PASSWORD}';"
mysql --user="root" --password="$MYSQL_ROOT_PASSWORD" -e "GRANT ALL PRIVILEGES ON ${DB_DATABASE}.* TO '${USER}'@'$SERVER_IP';"
